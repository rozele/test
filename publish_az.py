...
class AzureBlobPublisher(object):
    ...
    def __init__(
        ...
        self._http_directory = 'https://{}.blob.core.windows.net/{}/{}'.format(
                storage_account,
    ...
    def _upload_artifact(self, filepath):
        ...
        cmd = 'az storage blob upload -c {} -n {}/{} -f {} 1>&2'.format(
            self._blob_container, self._blob_container_path, filename, filename)
        if self._dry_run:
